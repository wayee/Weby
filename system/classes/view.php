...
class View {
	 ...
	 * @return  string
	 */
	protected static function capture($weby_view_filename, array $weby_view_data)
	{
		// Import the view variables to local namespace
		extract($weby_view_data, EXTR_SKIP);
	...
	public function & __get($key)
	{
		...
		{
			throw new Weby_Exception('View variable is not set: :var',
				array(':var' => $key));
		}
	}
	...
	{
		if (($path = Weby::find_file('views', $file)) === FALSE)
		{
			throw new Weby_Exception('The requested view :file could not be found', array(
				':file' => $file,
			));
		}
	...
	public function render($file = NULL)
	{
		...
		if (empty($this->_file))
		{
			throw new Weby_Exception('You must set the file to use within your view before rendering');
		}
