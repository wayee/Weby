...
class HTML {
	...
	{
		return htmlspecialchars((string) $value, ENT_QUOTES, Weby::$charset, $double_encode);
	}
	...
	{
		return htmlentities((string) $value, ENT_QUOTES, Weby::$charset, $double_encode);
	}
	...
	public static function attributes(array $attributes = NULL)
	{
		...
		foreach ($attributes as $key => $value)
		{
			...
			$compiled .= ' '.$key.'="'.htmlspecialchars($value, ENT_QUOTES, Weby::$charset).'"';
		}
