...
<body>
	...
	<p>
		The following tests have been run to determine if <a href="#">Weby</a> will work in your environment.
	</p>
	...
	<table cellspacing="0">
		<tr>
			...
			<?php else: $failed = TRUE ?>
				<td class="fail">Weby requires PHP 5.2.3 or newer, this version is <?php echo PHP_VERSION ?>.</td>
			<?php endif ?>
		</tr>
		<tr>
			<th>System Directory</th>
			<?php if (is_dir(SYSPATH) AND is_file(SYSPATH.'classes/weby'.EXT)): ?>
	...
	<?php if ($failed === TRUE): ?>
		<p id="results" class="fail">✘ Weby may not work correctly with your environment.</p>
	<?php else: ?>
	...
	<p>
		The following extensions are not required to run the Weby core, but if enabled can provide access to additional classes.
	</p>
	...
	<table cellspacing="0">
		<tr>
			...
			<?php if (extension_loaded('curl')): ?>
				<td class="pass">Pass</td>
			<?php else: ?>
				<td class="fail">Weby requires <a href="http://php.net/curl">cURL</a> for the Remote class.</td>
			<?php endif ?>
		</tr>
		<tr>
			...
			<?php if (extension_loaded('mcrypt')): ?>
				<td class="pass">Pass</td>
			<?php else: ?>
				<td class="fail">Weby requires <a href="http://php.net/mcrypt">mcrypt</a> for the Encrypt class.</td>
			<?php endif ?>
		</tr>
		<tr>
			<th>GD Enabled</th>
			<?php if (function_exists('gd_info')): ?>
				<td class="pass">Pass</td>
			<?php else: ?>
				<td class="fail">Weby requires <a href="http://php.net/gd">GD</a> v2 for the Image class.</td>
			<?php endif ?>
		</tr>
		<tr>
			<th>PDO Enabled</th>
			<?php if (class_exists('PDO')): ?>
				<td class="pass">Pass</td>
			<?php else: ?>
				<td class="fail">Weby can use <a href="http://php.net/pdo">PDO</a> to support additional databases.</td>
			<?php endif ?>
		</tr>
	</table>
